...
<div class="loaiphong" style=" background: linear-gradient( rgb(220, 243, 245), white);border:none; margin-top:-10px" >
        <h2  style="font-size:20px;text-align: center;">LOẠI PHÒNG</h2>
