    ...
    <div class="mota">
      ...
      <div class="mota_mota"> 
        <p> Sứ mệnh của khách sạn Lotus là mang đến cho người Việt Nam một trải nghiệm nghỉ dưỡng tinh khiết, cao quý và trường tồn,
            ...
            phong phú qua các hoạt động văn hóa độc đáo do chúng tôi tổ chức.
        </p>
      </div> 
    </div>

    <div class="mota">
      <img class="mota_hinhanh"src="img/dichvu/dv17.jpg" alt="">
      <div class="mota_mota">
        <p> Bên cạnh đó, khách sạn Lotus cũng hiểu rằng sự trường tồn
            ...
            mà còn mang đến cho bạn một trải nghiệm tinh túy của văn hóa và giá trị Việt Nam. Chúng tôi rất hân hạnh được phục vụ bạn. 
        </p>
      </div>
    </div>
