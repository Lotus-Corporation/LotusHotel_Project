...
<div class="layout_danhmuc">
    <div class="danhmuc"><h2 style="margin: 1% 0 0 2%"> Thêm chi tiết hóa đơn</h2>
        <form method="post" enctype="multipart/form-data" action="control/ctrl_them_cthd.php">
            <div>
                <label>Mã chi tiết hóa đơn</label><br>
                <input type="text" name="ma_cthd">
            </div>
            <div>
                ...
                <select name="ma_hd">
                    ...
                    ?>
                    <option value=<?php echo $row["MA_HD"]?>><?php echo $row["NGAYLAP_HD"]?></option>
                    <?php 
                    }
                    ?>
                </select>
